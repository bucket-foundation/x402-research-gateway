...
| **Unpaywall** | `researched` | `scholarly_metadata` | OA version lookup for any DOI | — | `https://api.unpaywall.org/v2/{doi}?email=...` | email-param | 100k/day | CC0 | `allowed` | raw | `unpaywall` | — | — | Resolver; returns best OA URL. Essential companion. |
